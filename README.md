...
- Database mirgrations are handelled by dropping and recreating tables during deployment (**switch to Alembic** planned, already listed in `requirements.txt` but is unused)
